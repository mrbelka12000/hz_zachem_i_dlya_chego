...
Живой инстанс: **https://finance.mrbelka12000.com/**
...
Это общий гостевой аккаунт — что туда добавишь, увидят остальные. Для своих данных регистрируй
отдельный логин.
...
### Шаг 2. Сложить секреты в env-файл на VPS
...
### Шаг 3. Первый запуск Swarm-сервиса
